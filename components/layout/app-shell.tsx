  ...
  return (
    <aside className={cn("hidden min-h-screen border-r border-synapse-border bg-synapse-elevated p-4 lg:block", collapsed ? "w-20" : "w-64")}>
      <div className="mb-8 flex items-center gap-3 px-2">
        <div className="grid h-10 w-10 place-items-center rounded-lg bg-synapse-primary text-card-title text-white">SC</div>
        {!collapsed ? (
          <div>
            <p className="text-card-title text-synapse-text">SynapseCore System</p>
            <p className="text-meta text-synapse-muted">Agentic HQ operations</p>
          </div>
        ) : null}
      </div>
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-synapse-border bg-synapse-page/90 px-4 py-4 backdrop-blur md:px-6">
      <div className="flex items-center gap-4">
        <button className="synapse-focus rounded-lg border border-synapse-border bg-synapse-elevated p-2 text-synapse-muted hover:text-white lg:hidden" type="button" aria-label="Open navigation">
          <Menu className="h-5 w-5" />
        </button>
        <div className="min-w-0 flex-1">
          <h1 className="truncate text-page-title text-synapse-text">{pageTitle}</h1>
        </div>
        <button className="synapse-focus rounded-lg border border-synapse-border bg-synapse-elevated p-2 text-synapse-muted hover:text-white" type="button" aria-label="Notifications">
